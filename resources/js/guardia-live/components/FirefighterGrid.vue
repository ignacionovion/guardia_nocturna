...
<template>
    <section class="flex flex-col h-full">
        <!-- Section header -->
        <div class="mb-4 pb-3 border-b border-slate-700/30">
            <h2 class="text-base font-semibold text-white">Personal en Guardia</h2>
            <p class="text-xs text-slate-500 mt-0.5">{{ store.visibleCount }} bomberos</p>
        </div>
