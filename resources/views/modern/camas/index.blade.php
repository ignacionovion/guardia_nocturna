...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-2 px-3 py-2 rounded-xl bg-white dark:bg-slate-900 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 dark:border-slate-800 p-4">
        <div class="flex items-center gap-4">
            <div class="flex-1">
                ...
                <div class="h-3 rounded-full bg-white dark:bg-slate-800 overflow-hidden">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 dark:border-slate-800 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 dark:border-slate-800 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4 text-xs">
                ...
                <div class="flex items-center gap-1.5">
                    <span class="w-4 h-4 rounded bg-white dark:bg-slate-800 dark:bg-slate-700 border-2 border-slate-400"></span>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                $estadoClasses = [
                    ...
                    'mantenimiento' => 'border-slate-300 dark:border-slate-600 dark:border-slate-600 bg-white dark:bg-slate-800 cursor-not-allowed opacity-60',
                ];
                $iconClasses = [
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 dark:border-slate-800 overflow-hidden">
        ...
        <div class="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            <div class="px-6 py-3 flex items-center gap-4 hover:bg-white dark:hover:bg-slate-800 dark:hover:bg-slate-800/50 transition-colors">
