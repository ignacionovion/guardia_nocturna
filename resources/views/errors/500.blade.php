...
@section('content')
    <div class="min-h-[60vh] flex items-center justify-center">
        <div class="text-center max-w-lg mx-auto">
            ...
            <h1 class="text-6xl font-extrabold text-slate-800 dark:text-white mb-2">500</h1>
            <h2 class="text-2xl font-bold text-slate-600 dark:text-slate-400 mb-4 uppercase tracking-wide">Error del Sistema</h2>
            ...
            <div class="flex justify-center gap-4">
                <a href="{{ url()->previous() }}" class="inline-flex items-center px-6 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 dark:text-slate-300 font-bold rounded-lg shadow-sm transition-all text-sm uppercase">
