...
@section('title', 'Crear Plantilla de Formulario')

@section('content')
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Nueva Plantilla</h1>
        <p class="text-gray-600 mt-2">Diseña tu formulario personalizado</p>
    </div>

    <form action="{{ route('forms.builder.store') }}" method="POST" id="formBuilder">
        @csrf
...
function agregarCampo(tipo = 'text') {
    ...
    campoDiv.innerHTML = `
        <div class="flex justify-between items-start mb-4">
            <h3 class="text-lg font-medium text-gray-900">Campo #${campoIndex}</h3>
