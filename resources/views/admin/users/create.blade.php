...
@section('content')
    <div class="max-w-4xl mx-auto pt-4">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-800 dark:text-white">Nuevo Usuario</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Crea una cuenta con acceso al sistema</p>
            </div>
