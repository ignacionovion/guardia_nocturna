                        ...
                        <div class="bg-slate-50 p-6 rounded-xl border border-slate-200">
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center p-3 bg-white border border-slate-200 rounded-lg hover:border-blue-400 cursor-pointer transition-all shadow-sm group">
                                    <input id="es_conductor" type="checkbox" name="es_conductor" value="1" {{ $volunteer->es_conductor ? 'checked' : '' }} class="rounded text-blue-600 focus:ring-blue-500 h-5 w-5 border-slate-300">
                                    <div class="ml-3">
