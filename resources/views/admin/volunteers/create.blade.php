                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="company" value="{{ old('company', '3ª Cía.') }}" 
                            ...
                            <div class="relative">
                                ...
                                <select name="position_text" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all appearance-none bg-white">
                                    ...
                                    <optgroup label="Oficiales Generales">
                                        ...
                                        <option value="Protesorero">Protesorero</option>
                                    ...
                                    <optgroup label="Oficiales de Mando">
                                        ...
                                        <option value="Teniente 4">Teniente 4</option>
                                    </optgroup>
                                    <optgroup label="Ayudantía">
                                        <option value="Ayudante 1">Ayudante 1</option>
                                        <option value="Ayudante 2">Ayudante 2</option>
                                        <option value="Ayudante 3">Ayudante 3</option>
                                    </optgroup>
                                    <optgroup label="Voluntarios">
                                        <option value="Honorario">Honorario</option>
                                        <option value="Bombero" selected>Bombero</option>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="call_code" value="{{ old('call_code') }}" 
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="portable_number" value="{{ old('portable_number') }}" 
                                    class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all">
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="role" class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white">
                                        <option value="bombero">Usuario Estándar (Bombero)</option>
                                        <option value="jefe_guardia">Jefe de Guardia</option>
                                        <option value="capitania">Oficial de Mando (Capitanía)</option>
                                ...
                                <label class="flex items-center p-3 bg-white border border-slate-200 rounded-lg hover:border-yellow-400 cursor-pointer transition-all shadow-sm mt-4 group">
                                    <input type="checkbox" name="is_shift_leader" value="1" class="rounded text-yellow-600 focus:ring-yellow-500 h-5 w-5 border-slate-300">
                                    <div class="ml-3">
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="address_commune" value="{{ old('address_commune') }}" 
                                class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all">
                        </div>
                        <div class="md:col-span-2 space-y-2">
