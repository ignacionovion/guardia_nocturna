...
<div class="space-y-2">
    ...
    <div class="overflow-x-auto">
        <table class="w-full border-collapse text-sm" style="min-width: 800px;">
            ...
            {{-- Linterna --}}
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Linterna NIGHTSTICK</td>
                ...
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Radios Baoffeng</td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600">
            ...
            {{-- ERA SCOTT --}}
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">ERA SCOTT 4.5</td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600">
            ...
            <tr class="bg-sky-100">
                ...
                <td colspan="1" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Lona organizadora material</td>
            ...
            {{-- Tablet --}}
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Tablet unidad BR-3 y Cargador</td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600">
                ...
                <td colspan="1" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Maleta SCI</td>
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600">
                    @if($readonly)
    ...
    <div class="overflow-x-auto">
        <table class="w-full border-collapse text-sm mt-2" style="min-width: 800px;">
            ...
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Bolso Oxigenoterapia</td>
            ...
            <tr class="bg-sky-100">
                ...
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Férulas</td>
            </tr>
            {{-- Tablas Largas y Tabla Scoop --}}
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Tablas Largas</td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600">
                ...
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Tabla Scoop</td>
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600">
                    @if($readonly)
            ...
            {{-- Tabla pediátrica --}}
            <tr class="bg-sky-100">
                <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Tabla pediátrica</td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600">
            ...
            <tr class="bg-sky-100">
                <td colspan="6" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Bolso TRIAGE</td>
                <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600">
                    @if($readonly)
    ...
    <div class="overflow-x-auto">
        <table class="w-full border-collapse text-sm mt-2" style="min-width: 800px;">
            ...
            <tr class="bg-sky-100">
                <td class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">38mm</div></td>
                ...
                <td class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">52mm</div></td>
                <td class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                    @if($readonly)
                ...
                <td class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">75mm</div></td>
                <td class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                    @if($readonly)
                ...
                <td class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">L D H</div></td>
                <td class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                    @if($readonly)
                ...
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Armada Base</div></td>
                <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                    @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Cantidad</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Llaves de copla</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Pitón Rosenbauer 52</div></td>
        </tr>
        ...
        <tr class="bg-sky-100">
            ...
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Manguera L D H</div></td>
        ...
        <tr class="bg-sky-100">
            ...
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Llave de grifo</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Trifurca</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            ...
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Traspaso grifo</div></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        {{-- Protecciones --}}
        <tr class="bg-sky-100">
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Protecciones duras para paciente</td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Cojines VETTER</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Eslings</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
        </tr>
        <tr class="bg-sky-100">
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        {{-- Tecle y caja --}}
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Tecle para cadena 2000kg</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Caja de Herramientas</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="6" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Cubre Airbag</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Barretilla</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Napoleón</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Set Stab Fast XL</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">First Responder Jack</div></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">2 cuerpos 12m</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">2 cuerpos 8m</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="6" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Escala plegable</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            ...
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Rozón</div></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Chuzo</div></td>
        </tr>
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
        ...
        {{-- Bicheros --}}
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Bicheros</td>
        ...
        {{-- Focos LED --}}
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Focos LED con cable y trípode</td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Hacha suela</div></td>
        ...
        {{-- Carrete cable --}}
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Carrete cable eléctrico</td>
        ...
        {{-- Cadenas Holmatro --}}
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Cadenas y puntas Holmatro</td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Extintor de agua</div></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Pitón monitor</div></td>
        </tr>
        <tr class="bg-sky-100">
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="4" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
        ...
        {{-- Corta parabrisas --}}
        <tr class="bg-sky-100">
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 font-bold text-sm">Corta parabrisas manual</td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Force</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
            ...
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Cámara Termal</div></td>
            <td colspan="2" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
                @if($readonly)
        ...
        <tr class="bg-sky-100">
            <td colspan="9" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 bg-teal-100 text-center"><div class="text-xs font-bold">Bomba Espalda</div></td>
        </tr>
        <tr class="bg-sky-100">
            <td colspan="9" class="p-1 border border-slate-300 dark:border-slate-600 bg-sky-100"></td>
            <td colspan="3" class="p-1 border border-slate-300 dark:border-slate-600 text-center">
    ...
    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-2 rounded mt-2">
        ...
        <div class="text-xs text-slate-600 dark:text-slate-400 italic">(4 palas, 2 pasatiras, 2 McLeod, 3 rastrillos cegadores, 2 Chorizos, 1 Filtro de aspiración)</div>
    </div>
