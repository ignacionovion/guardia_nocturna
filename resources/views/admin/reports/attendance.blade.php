...
<div class="container mx-auto px-4 py-6 max-w-7xl">
    ...
    <div class="mb-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 mt-1 text-sm">Resumen simple de asistencia por guardia y por voluntario.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-5">
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex justify-between py-1.5 border-b border-slate-100">
                    <span class="text-slate-500">Registros evaluados</span>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
        <div class="p-4 border-b border-slate-200 bg-emerald-50 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-base font-black text-slate-800 uppercase tracking-wide">Personal de Guardia</h3>
                    <p class="text-xs text-slate-500">Voluntarios titulares y con reemplazos del período</p>
                </div>
            </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="text-center py-3 px-2 font-semibold text-slate-500 text-xs uppercase">Noches</th>
                        ...
                        <th class="text-center py-3 px-3 font-semibold text-slate-600 text-xs uppercase">% Asistencia</th>
                    </tr>
                </thead>
