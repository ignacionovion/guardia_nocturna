...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-800 dark:text-white">Editar Unidad</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Actualiza nombre y descripción</p>
            </div>
            <a href="{{ route('admin.emergency-units.index') }}" class="inline-flex items-center text-slate-600 dark:text-slate-400 hover:text-slate-900">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            class="w-full px-4 py-3 border-2 border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-slate-700 dark:text-slate-300 bg-white">{{ old('description', $unit->description) }}</textarea>
                    </div>
                </div>
