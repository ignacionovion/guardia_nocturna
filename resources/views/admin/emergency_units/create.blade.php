...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Nueva Unidad</h1>
                <p class="text-gray-500 text-sm mt-1">Agrega una unidad/carro para emergencias</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <form method="POST" action="{{ route('admin.emergency-units.store') }}" class="p-6">
                @csrf
