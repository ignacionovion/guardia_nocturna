...
<div class="max-w-3xl mx-auto py-8 px-4">
    <div class="mb-8">
        ...
        <p class="text-slate-500 text-sm mt-1">Personaliza la información y apariencia de tu compañía</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.tenant-settings.update') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 mb-6">
            ...
            <div class="space-y-5">
                <div>
                    <label for="tenant_display_name" class="block text-sm font-medium text-slate-700 mb-1.5">Nombre para mostrar</label>
                ...
                <div>
                    <label for="tenant_timezone" class="block text-sm font-medium text-slate-700 mb-1.5">Zona Horaria</label>
                ...
                <div class="flex-shrink-0">
                    @if($settings['tenant_logo'])
                        <img src="{{ asset('storage/' . $settings['tenant_logo']) }}" alt="Logo"
                             class="w-24 h-24 object-contain rounded-xl border border-slate-200 bg-white p-2">
                    @else
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="tenant_email_from" class="block text-sm font-medium text-slate-700 mb-1.5">Correo Remitente</label>
                ...
                <div>
                    <label for="tenant_email_name" class="block text-sm font-medium text-slate-700 mb-1.5">Nombre Remitente</label>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="tenant_primary_color" class="block text-sm font-medium text-slate-700 mb-1.5">Color Primario</label>
                    <div class="flex items-center space-x-3">
                        ...
                        <input type="text" value="{{ old('tenant_primary_color', $settings['tenant_primary_color'] ?? '#f59e0b') }}"
                               class="flex-1 px-4 py-2.5 border border-slate-300 rounded-xl text-sm bg-slate-50" readonly
                               id="primary_color_text">
                    </div>
                </div>
                <div>
                    <label for="tenant_secondary_color" class="block text-sm font-medium text-slate-700 mb-1.5">Color Secundario</label>
                    <div class="flex items-center space-x-3">
        ...
        @else
        <div class="bg-slate-50 rounded-2xl border border-slate-200 p-6 mb-6 opacity-60">
            <h2 class="text-lg font-semibold text-slate-500 mb-2">Personalización Visual</h2>
        ...
        <div class="bg-slate-50 rounded-2xl border border-slate-200 p-6 mb-6">
            <h2 class="text-lg font-semibold text-slate-700 mb-3">Tu Plan</h2>
