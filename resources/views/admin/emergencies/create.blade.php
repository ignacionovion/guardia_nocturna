...
@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Nueva Emergencia</h1>
                <p class="text-gray-500 dark:text-slate-400 text-sm mt-1">Registra una emergencia ocurrida durante la guardia</p>
            </div>
