    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mt-6 bg-white dark:bg-slate-900 rounded-2xl border border-teal-900/20 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-teal-900/20 bg-sky-100">
                <div class="text-xs font-black uppercase tracking-widest text-slate-600 dark:text-slate-400">Movimientos</div>
                <div class="text-sm text-slate-600 dark:text-slate-400 mt-1">Ingresos y egresos registrados en la bodega.</div>
            </div>
