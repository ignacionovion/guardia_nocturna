...
<head>
    ...
    <title>Inventario - QR para retiro</title>
    <style>
        @page { margin: 12mm; }
...
<div class="wrap">
    <div class="card">
        <div class="top">
            <div>
                <div class="kicker">Inventario</div>
                <div class="title">Retiro de bodega</div>
                <div class="subtitle">Escanea el QR y sigue el flujo: RUT → Retiro.</div>
            </div>
            <div class="brand">
            ...
            <div>
                <div class="steps">
                    ...
                    <ol>
                        ...
                        <li>Selecciona el ítem y la cantidad a retirar.</li>
                    </ol>
        ...
        <div class="screen-only">
            ...
            <a class="btn secondary" href="{{ route('inventario.qr.admin') }}">Volver</a>
        </div>
    </div>
</div>
</body>
