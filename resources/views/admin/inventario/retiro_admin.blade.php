            ...
            <div class="p-6 border-t border-slate-800 bg-white/5">
                ...
                <form method="POST" action="{{ route('inventario.retiro.store') }}" class="mt-4 space-y-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('inventario.retiro.identificar.form') }}" class="w-1/2 inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white font-bold py-3 px-6 rounded-xl text-[11px] uppercase tracking-wider border border-slate-700">
                            <i class="fas fa-id-card"></i>
                            Cambiar RUT
                        </a>
                ...
                <div class="mt-8 bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
                    <div class="p-6 border-b border-white/10">
                        <div class="text-sm font-bold uppercase tracking-wider text-slate-300">Historial</div>
                            ...
                            <div class="overflow-x-auto rounded-xl border border-white/10">
                                <table class="min-w-full text-sm">
                                    <thead class="bg-white/5 border-b border-white/10">
                                        <tr class="text-xs font-semibold uppercase tracking-wider text-slate-300">
                                    ...
                                    <tbody class="divide-y divide-white/10">
                                        @foreach($movimientos as $m)
                                            <tr>
                                                ...
                                                <td class="px-4 py-3">
                                                    @if(($m->tipo ?? '') === 'ingreso')
                                                        <span class="inline-flex items-center rounded-full bg-sky-500/15 text-sky-200 border border-sky-500/30 px-2 py-1 text-[10px] font-bold uppercase tracking-wider">Ingreso</span>
                                                    @else
                                                        <span class="inline-flex items-center rounded-full bg-rose-500/15 text-rose-200 border border-rose-500/30 px-2 py-1 text-[10px] font-bold uppercase tracking-wider">Egreso</span>
                                                    @endif
                                                </td>
