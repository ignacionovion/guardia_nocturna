    ...
    <div class="z-10 text-center px-4 max-w-3xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            @if (Route::has('tenant.login') || Route::has('central.login'))
                ...
                @else
                    <a href="/" class="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-900 hover:bg-white dark:hover:bg-slate-800 text-slate-900 font-bold rounded-xl transition-all shadow-lg hover:shadow-white/10 transform hover:-translate-y-1 flex items-center justify-center text-lg uppercase tracking-wide">
