...
<div {{ $attributes->merge([
    ...
    <div class="flex items-start gap-4">
        ...
        <div class="relative shrink-0">
            <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center text-white font-bold">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-start justify-between gap-2">
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-0.5">
                        ...
                        <span class="text-xs text-slate-400">#{{ $volunteer->numero }}</span>
                        @endif
                    </div>
                </div>
            ...
            {{-- Bed info --}}
            @if($bed)
            <div class="mt-2 inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-blue-100 text-blue-700 text-[10px] font-medium">
