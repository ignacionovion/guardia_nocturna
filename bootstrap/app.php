...
return Application::configure(basePath: dirname(__DIR__))
    ->withProviders([
        // Forzar registro de RouteServiceProvider para rutas centrales
        \App\Providers\RouteServiceProvider::class,
    ])
    ->withRouting(
        // web: routes are registered by RouteServiceProvider (central) and TenancyServiceProvider (tenant)
